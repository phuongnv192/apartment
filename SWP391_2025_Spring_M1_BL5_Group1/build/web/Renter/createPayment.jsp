        ...
        <div class="main">
            <div class="container" style="margin-top: 2em">
                <form action="createPayment" method="post">
                    <div class="mb-3 mt-3">
                        <label for="guide-name" style="font-weight: 700" class="form-label">Input money you want to deposit to system (minimum 10000 VND): </label>
                        <input type="number" class="form-control" id="money" placeholder="Enter money" name="money" min="10000" max="10000000" required>
                    </div>
