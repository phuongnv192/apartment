    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                    ...
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Enter your full name" 
                                   name="username" id="username" required maxlength="30"
                                   value="${user.userName}">
                        ...
                        <div class="input-box">
                            ...
                            <span id="emailError" class="error-message">${errEmail}</span>
                        </div>
                        <div class="input-box">
                            <span class="details">Phone Number</span>
                            <input type="text" placeholder="Enter your number" 
                                   name="phone" id="phone" required maxlength="12"
                                   value="${user.userPhone}">
                            <span id="phoneError" class="error-message">${errPhone}</span>
                        </div>
                        <div class="input-box">
                            ...
                            <input 
                                ...
                                name="dob" 
                                id="dob"
                                value="<fmt:formatDate value="${user.formattedDate}" pattern="dd/MM/yyyy"/>"
                                >
                        ...
                        <div class="input-box">
                            ...
                            <select name="role" style="width: 300px; height: 44px; border-radius: 5px; padding-left: 15px; font-size: 16px;">
                                <option value="1" selected="selected">Renter</option>
                ...
                <div class="form1">
                    <div class="button">
                        <a href="login"><input type="submit" value="Back to Login" style="width: 650px;"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function getErrorMessage(errorId) {
                    switch (errorId) {
                        ...
                        case "phoneError":
                            return "Phone must be in Vietnamese format (e.g., 0123456789 or +84123456789)";
                        case "dobError":
